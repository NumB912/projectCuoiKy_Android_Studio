...
class WeekAdapter(val context: Context,private val weekDays: ArrayList<LocalDate>) : RecyclerView.Adapter<WeekAdapter.WeekViewHolder>() {
    ...
    fun setItem(holder: WeekViewHolder,day: LocalDate,position: Int ,today:LocalDate){
        ...
        holder.itemView.setOnClickListener{
            setBackGroundAndCheck(holder,R.color.blueBocchi,Color.WHITE)
            var oldPosition = selectedPosition
